...
\thispagestyle{empty}
\begin{center}
  {\sffamily\bfseries\LARGE 從頻道表現到留言社群洞察：\\[2pt]
   台灣 YouTube 頻道的 Audience Intelligence 分析\par}
  \vspace{6pt}
  {\sffamily\large 以 The DoDo Men－嘟嘟人為例\par}
  \vspace{10pt}
...
回訪率、\eng{co-commenter network} 社群偵測、Qwen 情緒與 \eng{Aspect-Based Sentiment Analysis}
（ABSA）、\eng{reply-thread conflict} 分析與外部事件時間軸，並以 48 個台灣頻道作為 \eng{broad benchmark}。
