...
\textbf{綜合判讀。} 綜合上述\textbf{原始指標}（而非合成評分），The DoDo Men 的留言社群整體健康，可由三個面向
描述：(1) \textbf{黏著}——互動主要來自穩定核心與回訪觀眾（核心與常客層貢獻近三成留言、跨影片與近期回訪率分別
位於同儕 PR~81 與 PR~91）；(2) \textbf{情緒}——整體偏正面（正面率 PR~73）且負面率低於同儕（PR~38）；
(3) \textbf{集中}——留言互動高度集中於三個觀眾群（最大社群占 47.7\%、HHI~$=0.37$）。換言之，頻道擁有穩定、
願意回訪的主力留言社群與健康的整體情緒，但互動高度集中於少數觀眾群，內容擴張時需留意是否能觸及核心以外的受眾。
\textbf{對 RQ1 的回答}：The DoDo Men 的留言社群整體健康，互動主要來自穩定核心與回訪觀眾，而非一次性流量。
...
差異（表~\ref{tab:sensitivity}）。例如三群都會留言「職場科技」內容，但挑戰冒險型的負面率（14\%，$n{=}2{,}493$）
明顯高於知識職涯型（5\%，$n{=}11{,}547$），差距達 8 個百分點，且經兩比例 $z$ 檢定達高度顯著（$z{=}15.3$、
$p<0.001$）；「產品開箱」則以知識職涯型最易負面（12\%，$p<0.01$）。相對地，「荒野求生」三群負面率接近
（$\sim$10--11\%），代表此主題的反應在各群間一致，差異主要由主題本身而非特定社群造成。

\begin{table}[H]
\centering
\caption{同一主題內不同社群的負面率（括號為各社群在該主題的留言數）}
\label{tab:sensitivity}
\small
\begin{tabular}{l ccc c}
\toprule
\textbf{主題} & \textbf{知識職涯型} & \textbf{挑戰冒險型} & \textbf{旅遊來賓型} & \textbf{差距／顯著性}\\
\midrule
職場科技 & 5\%\,{\scriptsize(11.5k)} & \textbf{14\%}\,{\scriptsize(2.5k)} & 9\%\,{\scriptsize(2.1k)} & 8pp$^{***}$ \\
產品開箱 & \textbf{12\%}\,{\scriptsize(668)} & 7\%\,{\scriptsize(633)} & 10\%\,{\scriptsize(210)} & 5pp$^{**}$ \\
團隊日常 & 3\%\,{\scriptsize(16.4k)} & \textbf{7\%}\,{\scriptsize(7.4k)} & 6\%\,{\scriptsize(4.3k)} & 4pp$^{***}$ \\
\midrule
荒野求生（對照） & 11\%\,{\scriptsize(712)} & 10\%\,{\scriptsize(7.6k)} & 10\%\,{\scriptsize(715)} & $\sim$1pp \\
\bottomrule
\end{tabular}

\vspace{2pt}
{\footnotesize 註：差距為最高與最低社群之負面率差。$^{**}p<0.01$、$^{***}p<0.001$（最易負面 vs 最不易負面
社群之兩比例 $z$ 檢定：職場科技 $z{=}15.3$、團隊日常 $z{=}14.8$、產品開箱 $z{=}3.0$）；荒野求生作為對照，
三群負面率接近，差異主要源自主題本身。}
\end{table}
